...
import { Instagram, ExternalLink, Send, Sun, Moon, Toolbox } from 'lucide-react';
...
const DATA: UserConfig = {
  ...
  links: [
    ...
    { id: '4', title: 'Herramientas', url: 'https://midnight-studio-systems.vercel.app/', icon: Toolbox },
  ]
};
